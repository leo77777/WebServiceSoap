 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service.leo.fr/", wsdlLocation = "http://localhost:8585/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://service.leo.fr/", "BanqueServiceService");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://service.leo.fr/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.leo.fr/", "BanqueWSPort"), BanqueWS.class, features);
    }
